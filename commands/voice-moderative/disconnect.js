...
run: async(client, interaction) => {
 ...
 const novc = client.modules.embed(client, client.colors.red, `${client.emotes.check} | **<@${member.id}> is not in a Voice Channel.**`)
 ...
 const noone = client.modules.embed(client, client.colors.red, `${client.emoted.check} | **Noone has joined <#${channel.id}>.**`)
